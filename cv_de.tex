...
\begin{document}
\name{Jonas Schäfer}
\tagline{Informatiker mit Expertise für nachhaltige Entwicklung}
...
\cvevent{Leiter für Europäische Partnerschaften}{\href{https://climatescience.org}{ClimateScience}}{Dez 2021 -- Jun 2022}{Remote}{\textbf{Vollzeit}}
\begin{itemize}
...
\cvevent{Webentwickler \& Leiter für Deutsche Partnerschaften}{\href{https://climatescience.org}{ClimateScience}}{Dez 2019 --  Dez 2021}{Remote}{Teilzeit}
\begin{itemize}
    \item Programmierung der Frontend-Webseiten und des Authentifizierungs-\\
    moduls unserer \hrefUI{https://climatescience.org/de}{Website}, die \textbf{über 100.000 registrierte User} bedient.
...
\cvhighlight{\faGlobeAfrica}{Aufbau führender Klima-NGO}{Seit der Gründung in 2019 bin ich bei \hrefUI{https://climatescience.org}{ClimateScience} ehrenamtlich involviert. Als Informatiker, Projektleiter und Führungskraft trug ich maßgeblich zum Wachstum der inzwischen \textbf{weltweit größten Wohltätigkeitsorganisation für Klimabildung} bei.}
...
\begin{itemize}
    \item Dez 2022: Herbstworkshop zu EU \textbf{Gesetzgebungsverfahren} bei \hrefU{https://www.europeanhorizons.org/}{European Horizons}
\end{itemize}
